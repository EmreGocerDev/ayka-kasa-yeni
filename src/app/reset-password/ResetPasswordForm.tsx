...
export default function ResetPasswordForm() {
  ...
  // useEffect bloğu buradan kaldırıldı çünkü artık auth/callback rotası
  // bu sayfaya gelmeden önce gerekli oturum doğrulamasını yapıyor.
  ...
  const handlePasswordReset = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Bu fonksiyon artık geçerli bir oturum olduğu için sorunsuz çalışacak.
